...
func (x *UserDetailsRequest) GetChatid() int64 {
	if x != nil {
		return x.Chatid
	}
	return 0
...
type UserDetailsResponse struct {
	...
	Gooddeals  bool   `protobuf:"varint,3,opt,name=gooddeals,proto3" json:"gooddeals,omitempty"`
	Superdeals bool   `protobuf:"varint,4,opt,name=superdeals,proto3" json:"superdeals,omitempty"`
	Keywords   string `protobuf:"bytes,5,opt,name=keywords,proto3" json:"keywords,omitempty"`
	Dealssent  string `protobuf:"bytes,6,opt,name=dealssent,proto3" json:"dealssent,omitempty"`
}
...
func (x *UserDetailsResponse) GetChatid() int64 {
	if x != nil {
		return x.Chatid
	}
	return 0
...
func (x *UserDetailsResponse) GetGooddeals() bool {
	if x != nil {
		return x.Gooddeals
	}
	return false
...
func (x *UserDetailsResponse) GetSuperdeals() bool {
	if x != nil {
		return x.Superdeals
	}
	return false
...
func (x *UserDetailsResponse) GetKeywords() string {
	if x != nil {
		return x.Keywords
	}
	return ""
...
func (x *UserDetailsResponse) GetDealssent() string {
	if x != nil {
		return x.Dealssent
	}
	return ""
...
var file_api_v1_service_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x22, 0x2c,
	...
	,
...
var file_api_v1_service_proto_goTypes = []interface{}{
	(*UserDetailsRequest)(nil),  // 0: api.v1.UserDetailsRequest
	(*UserDetailsResponse)(nil), // 1: api.v1.UserDetailsResponse
}
var file_api_v1_service_proto_depIdxs = []int32{
	0, // 0: api.v1.KramerService.GetUserDetails:input_type -> api.v1.UserDetailsRequest
	1, // 1: api.v1.KramerService.GetUserDetails:output_type -> api.v1.UserDetailsResponse
